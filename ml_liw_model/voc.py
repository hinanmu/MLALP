...
def download_voc2007(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2007['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2007['trainval_2007'], cached_file)
    ...
    if not os.path.exists(test_anno):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2007['test_images_2007'], cached_file)
    ...
    if not os.path.exists(test_image):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2007['test_anno_2007'], cached_file)
...
def download_voc2012(root):
    ...
    if not os.path.exists(path_devkit):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2012['devkit'], cached_file)
    ...
    if not os.path.exists(path_images):
        ...
        if not os.path.exists(cached_file):
            ...
            util.download_url(urls2012['trainval_2012'], cached_file)
    ...
    #
    #     # download test annotations
    #     parts = urlparse(urls2012['test_images_2007'])
    #     filename = os.path.basename(parts.path)
    #     cached_file = os.path.join(tmpdir, filename)
    #
    #     if not os.path.exists(cached_file):
    #         print('Downloading: "{}" to {}\n'.format(urls2012['test_images_2007'], cached_file))
    #         util.download_url(urls2012['test_images_2007'], cached_file)
    #
    #     # extract file
    #     print('[dataset] Extracting tar file {file} to {path}'.format(file=cached_file, path=root))
    #     cwd = os.getcwd()
    ...
    #
    #     # download test images
    #     parts = urlparse(urls2012['test_anno_2007'])
    #     filename = os.path.basename(parts.path)
    #     cached_file = os.path.join(tmpdir, filename)
    #
    #     if not os.path.exists(cached_file):
    #         print('Downloading: "{}" to {}\n'.format(urls2012['test_anno_2007'], cached_file))
    #         util.download_url(urls2012['test_anno_2007'], cached_file)
    #
    #     # extract file
    #     print('[dataset] Extracting tar file {file} to {path}'.format(file=cached_file, path=root))
    #     cwd = os.getcwd()
